...
/**
 * FILE: login.php
 * PURPOSE: Shows the login form where users enter their username and password to sign in.
 * USED BY: `AuthController::showLogin()` and `AuthController::login()` rendering flows.
 * DESIGN PATTERN: None (views do not contain pattern logic)
 */
?>
<?php // VIEW FOR: AuthController::showLogin / AuthController::login ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
